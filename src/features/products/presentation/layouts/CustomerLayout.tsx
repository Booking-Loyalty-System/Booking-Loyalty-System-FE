  ...
  const rawMenuItems: MenuItem[] = [
    {
      ...
      icon: (isActive) => (
        <div
          className={`p-2 rounded-lg transition-all duration-300 group-hover:scale-110 ${isActive ? "bg-[#1e6ffd] text-white shadow-sm" : "bg-blue-50 text-[#1e6ffd]"}`}
        >
    ...
    },
    {
      ...
      icon: (isActive) => (
        <div
          className={`p-2 rounded-lg transition-all duration-300 group-hover:translate-x-1 ${isActive ? "bg-[#10b981] text-white shadow-sm" : "bg-emerald-50 text-[#10b981]"}`}
        >
    ...
    },
    {
      ...
      icon: (isActive) => (
        <div
          className={`p-2 rounded-lg ${isActive ? "bg-red-500 text-white shadow-sm" : "bg-red-50 text-red-500"}`}
        >
    ...
    },
    {
      ...
      icon: (isActive) => (
        <div
          className={`p-2 rounded-lg transition-all duration-300 group-hover:scale-110 ${isActive ? "bg-[#f59e0b] text-white shadow-sm" : "bg-amber-50 text-[#f59e0b]"}`}
        >
    ...
    },
    {
      ...
      icon: (isActive) => (
        <div
          className={`p-2 rounded-lg transition-all duration-300 ${isActive ? "bg-pink-500 text-white shadow-sm" : "bg-pink-50 text-pink-500 group-hover:animate-bounce"}`}
        >
    ...
    },
    {
      ...
      icon: (isActive) => (
        <div
          className={`p-2 rounded-lg transition-all duration-300 group-hover:-rotate-12 ${isActive ? "bg-[#a855f7] text-white shadow-sm" : "bg-purple-50 text-[#a855f7]"}`}
        >
    ...
    },
    {
      ...
      icon: (isActive) => (
        <div
          className={`p-2 rounded-lg transition-all duration-300 ${isActive ? "bg-[#06b6d4] text-white shadow-sm" : "bg-cyan-50 text-[#06b6d4]"}`}
        >
    ...
    },
    {
      ...
      icon: (isActive) => (
        <div
          className={`p-2 rounded-lg transition-all duration-300 group-hover:translate-x-0.5 ${isActive ? "bg-[#14b8a6] text-white shadow-sm" : "bg-teal-50 text-[#14b8a6]"}`}
        >
          <Car className="w-4 h-4" />
        </div>
      ),
    },
    {
      ...
      icon: (isActive) => (
        <div
          className={`p-2 rounded-lg transition-all duration-300 ${isActive ? "bg-slate-700 text-white shadow-sm" : "bg-slate-100 text-slate-600"}`}
        >
    ...
    },
    {
      ...
      icon: (isActive) => (
        <div
          className={`p-2 rounded-lg transition-all duration-300 group-hover:rotate-45 ${isActive ? "bg-blue-600 text-white shadow-sm" : "bg-blue-50 text-blue-600"}`}
        >
