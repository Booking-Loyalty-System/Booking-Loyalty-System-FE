...
export const ProfileSettings: React.FC = () => {
  ...
  const { user, changePassword, isChangingPassword } = useAuth(); // ĐÃ SỬA: Lấy thêm user từ useAuth
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  type="email"
                  readOnly
                  value={customerMe?.email || user?.email || ""} // ĐÃ SỬA: Xóa john.doe@gmail ảo
          ...
          <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm space-y-5">
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 border-t border-slate-100 flex items-center justify-between gap-4">
                ...
                >
                  <span
                    className={`absolute top-1 left-1 bg-white w-4 h-4 rounded-full transition-transform ${twoFactor ? "translate-x-5" : "translate-x-0"}`}
                  />
                </button>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-lg font-black tracking-wide">
                  {/* ĐÃ SỬA: Lấy từ createdAt thực tế hoặc fallback */}
            ...
            <div className="space-y-3.5">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`w-11 h-6 rounded-full transition-colors relative shrink-0 ${emailNotify ? "bg-blue-600" : "bg-slate-200"}`}
                >
                  <span
                    className={`absolute top-1 left-1 bg-white w-4 h-4 rounded-full transition-transform ${emailNotify ? "translate-x-5" : "translate-x-0"}`}
                  />
                </button>
              </div>
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`w-11 h-6 rounded-full transition-colors relative shrink-0 ${smsNotify ? "bg-blue-600" : "bg-slate-200"}`}
                >
                  <span
                    className={`absolute top-1 left-1 bg-white w-4 h-4 rounded-full transition-transform ${smsNotify ? "translate-x-5" : "translate-x-0"}`}
                  />
                </button>
              </div>
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`w-11 h-6 rounded-full transition-colors relative shrink-0 ${marketingEmail ? "bg-blue-600" : "bg-slate-200"}`}
                >
                  <span
                    className={`absolute top-1 left-1 bg-white w-4 h-4 rounded-full transition-transform ${marketingEmail ? "translate-x-5" : "translate-x-0"}`}
                  />
                </button>
              </div>
            </div>
