          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50/70 dark:bg-white/5 border-b border-slate-100 dark:border-white/5 text-slate-400 dark:text-slate-500 text-xs font-bold uppercase tracking-wider">
                ...
                <th className="py-4 px-6">
                  {t("bookingHistory.table.dateTime")}
                </th>
                <th className="py-4 px-6">
                  {t("bookingHistory.table.vehicle")}
                </th>
                <th className="py-4 px-6">
                  {t("bookingHistory.table.status")}
                </th>
                <th className="py-4 px-6">{t("bookingHistory.table.price")}</th>
                <th className="py-4 px-6 text-right">
                  {t("bookingHistory.table.actions")}
                </th>
              </tr>
            </thead>
              ...
              {sortedBookings.length === 0 ? (
                ...
                sortedBookings.map((item) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-6">
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold ${getStatusStyles(item.status)}`}
                      >
                        {t(
                          `bookingHistory.status.${item.status.replace(" ", "")}` as any,
