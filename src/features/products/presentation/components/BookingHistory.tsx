...
import { 
    Calendar, Star, Clock, DollarSign, Search, Filter, 
    Download, ArrowRight, ArrowLeft, XCircle, QrCode, 
    ...
    if (isError) {
        return (
            <div className="bg-red-50 border border-red-100 rounded-2xl p-8 text-center space-y-4">
                ...
                <p className="text-red-600">We couldn't load your booking history. Please try refreshing the page.</p>
            </div>
        );
    }
            ...
            <div className="bg-white border border-slate-100 rounded-2xl shadow-sm overflow-hidden">
                {filteredBookings.length === 0 ? (
                    <div className="py-20 text-center">
                        ...
                        <p className="text-slate-500 text-sm">You haven't made any bookings that match your criteria.</p>
                    </div>
                ) : (
                ...
                <div className="p-5 border-t border-slate-100 flex items-center justify-between text-xs font-bold text-slate-400 uppercase tracking-widest">
                    ...
                    <div className="flex gap-2">
                        <button disabled className="p-2 border border-slate-100 rounded-lg opacity-50 cursor-not-allowed">
