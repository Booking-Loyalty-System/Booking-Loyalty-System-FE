    ...
    return (
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                ...
                <div onClick={onAddNewVehicle} className="cursor-pointer border-2 border-dashed border-[#cbd5e1] dark:border-white/10 hover:border-[#1e6ffd] dark:hover:border-blue-500 bg-white dark:bg-[#111] hover:bg-blue-50/10 dark:hover:bg-blue-900/10 rounded-2xl p-5 transition-all duration-200 flex flex-col items-center justify-center min-h-[142px] group">
