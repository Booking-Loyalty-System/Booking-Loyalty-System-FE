...
import type { Vehicle } from "@/features/products/domain/models/vehicle/vehicle.model";
    ...
    >
      <div>
        <div className="flex items-center justify-between border-b border-slate-50 pb-4 mb-4">
          {/* Changed car.type to car.vehicleType */}
          <div
          ...
          <div className="flex items-center gap-1">
            ...
            <button className="p-2 text-slate-400 hover:text-rose-600 rounded-lg hover:bg-rose-50/50">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-xs font-semibold text-slate-400">Color</p>
              <p className="text-sm font-bold text-slate-800">{car.color}</p>
            </div>
            <div>
              <p className="text-xs font-semibold text-slate-400">Plate</p>
