...
import { BranchStep } from "./booking/BranchStep";
...
import type { PaymentMethod } from "./booking/PaymentStep";
import { SummaryStep, BookingSuccessModal } from "./booking/SummaryStep";
...
export const BookingPage: React.FC = () => {
  ...
  const [selectedPackage, setSelectedPackage] = useState<WashPackage | null>(
    null,
  );
          ...
          return (
            <React.Fragment key={step.key}>
              <div className="flex flex-col items-center relative">
                ...
                <span
                  className={`absolute -bottom-7 text-xs font-bold whitespace-nowrap ${
                    isActive
                      ? "text-blue-600"
                      : isCompleted
                        ? "text-green-600"
