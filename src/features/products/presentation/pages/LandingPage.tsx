...
import { MapModal } from "@/features/products/presentation/components/customer/MapModal";
...
export const LandingPage: React.FC = () => {
  ...
  const totalPages =
    Math.ceil((feedbackData?.totalFeedbacks || 0) / feedbackPageSize) || 1;
      ...
      if (i <= fullStars) {
        ...
        stars.push(
          <div key={i} className="relative shrink-0 select-none">
            <Star
              className={`${isLarge ? "w-6 h-6" : "w-4 h-4"} text-slate-300 dark:text-slate-700`}
            />
            <div className="absolute inset-0 overflow-hidden w-1/2">
              <Star
                className={`${isLarge ? "w-6 h-6" : "w-4 h-4"} fill-amber-400 text-amber-400`}
              />
            </div>
          </div>,
        );
  ...
  return (
    <div className="w-full min-h-screen bg-[hsl(210,92%,91%)] dark:bg-[#0B0C10] font-sans text-slate-800 dark:text-slate-200 selection:bg-sky-400 selection:text-white antialiased transition-colors duration-300 overflow-x-hidden relative">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 dark:hidden">
        {/* Orb góc trên trái */}
        <div
          className="absolute -top-40 -left-40 w-[700px] h-[700px] rounded-full bg-gradient-to-br from-sky-400/85 via-blue-200/40 to-transparent blur-3xl animate-pulse"
          style={{ animationDuration: "9s" }}
        />
        {/* Orb góc dưới phải */}
        <div
          className="absolute -bottom-40 -right-20 w-[600px] h-[600px] rounded-full bg-gradient-to-tl from-cyan-400/75 via-sky-200/35 to-transparent blur-3xl animate-pulse"
          style={{ animationDuration: "12s", animationDelay: "4s" }}
        />
        {/* Orb giữa-trái */}
        <div
          className="absolute top-1/3 -left-20 w-[400px] h-[400px] rounded-full bg-gradient-to-r from-blue-300/65 to-transparent blur-2xl animate-pulse"
      ...
      <header className="fixed top-0 inset-x-0 z-50 bg-white/65 dark:bg-[#0a0a0a]/70 backdrop-blur-2xl border-b border-sky-200/50 dark:border-white/10 px-6 lg:px-12 py-4 flex items-center justify-between transition-all duration-300 shadow-[0_1px_24px_rgba(14,165,233,0.07)] dark:shadow-none">
        <div className="flex items-center gap-3 group cursor-pointer">
          ...
          <div>
            <span className="font-extrabold text-xl tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-slate-900 to-slate-700 dark:from-white dark:to-slate-300">
              AutoWash Premium
            </span>
            <span className="text-[10px] block font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest -mt-1">
              {t("landing.subtitle")}
            </span>
          </div>
        </div>
      ...
      <section className="relative min-h-[100vh] flex items-center pt-24 pb-12 px-6 lg:px-12 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none">
          ...
          <div
            className="absolute top-[30%] right-[-10%] w-[600px] h-[600px] bg-cyan-300/20 dark:bg-purple-600/20 rounded-full blur-[120px] mix-blend-multiply dark:mix-blend-lighten animate-pulse"
              ...
              <div className="relative bg-white/80 dark:bg-[#111111]/80 backdrop-blur-2xl border border-white/50 dark:border-white/10 p-8 rounded-[2.5rem] shadow-2xl">
                <div className="flex justify-between items-center mb-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm font-bold text-blue-950 dark:text-white uppercase tracking-wider">
                        {t("landing.membershipBenefits")}
                      </p>
                      <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
                        {t("landing.earnAndUpgrade")}
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-slate-50 dark:bg-white/5 rounded-2xl flex items-center gap-4 border border-slate-100 dark:border-white/5">
                    ...
                    <div className="flex-1">
                      <div className="text-sm font-bold text-blue-950 dark:text-white">
                        Premium Wash
                      </div>
                      <div className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                        45 mins • Interior & Exterior
                      </div>
                    </div>
                  </div>
                  <div className="p-4 bg-slate-50 dark:bg-white/5 rounded-2xl flex items-center gap-4 border border-slate-100 dark:border-white/5">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-20 space-y-4">
            <h2 className="text-4xl lg:text-5xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-500 dark:text-white">
              {t("landing.ourPackages")}
            </h2>
            <p className="text-lg text-slate-500 dark:text-slate-400 font-medium">
              {t("landing.ourPackagesDesc")}
            </p>
          </div>
              ...
              {washPackages.map((pkg, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <div
                        className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-8 shadow-sm border group-hover:scale-110 transition-transform duration-300 ${
                          isPremium
                      ...
                      >
                        {idx === 0 ? (
                          <Droplets
                            className={`w-8 h-8 ${!isPremium && "text-blue-500"}`}
                          />
                        ) : idx === 1 ? (
                          <Star
                            className={`w-8 h-8 ${!isPremium && "text-indigo-500"}`}
                          />
                        ) : (
                          <Sparkles
                            className={`w-8 h-8 ${!isPremium && "text-purple-500"}`}
                          />
                        )}
                      </div>

                      <h3 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-500 dark:text-white mb-3">
                        {pkg.name}
                      </h3>
                      ...
                      <div className="flex items-end gap-2 mb-10">
                        <span className="text-4xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-500 dark:text-white">
                          {formatCurrency(pkg.price)}
                        </span>
                        <span className="text-slate-400 dark:text-slate-500 font-bold text-sm mb-1">
                      ...
                      {pkg.features && (
                        <ul className="space-y-4 mb-10">
                          {pkg.features.map((feature, fIdx) => (
                            <li
                              key={fIdx}
                              className="flex items-start gap-3 text-sm text-slate-700 dark:text-slate-300 font-medium"
                            >
      ...
      <section className="relative py-32 px-6 lg:px-12 bg-slate-50 dark:bg-[#08090C] overflow-hidden border-t border-slate-200 dark:border-white/5">
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-20 space-y-4">
            <h2 className="text-4xl lg:text-5xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-500 dark:text-white">
              {t("landing.membershipTiersTitle")}
            </h2>
            <p className="text-lg text-slate-500 dark:text-slate-400 font-medium">
              {t("landing.membershipTiersDesc")}
            </p>
          </div>
            ...
            {tiers.map((tItem) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${tItem.bgColor} opacity-0 group-hover:opacity-10 transition-opacity duration-300`}
                  ></div>
                  <div
                    className={`absolute top-0 inset-x-0 h-1.5 bg-gradient-to-r ${tItem.bgColor}`}
                  ></div>

                  <div className="p-8 relative z-10">
                    <div
                      className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 bg-gradient-to-br ${tItem.bgColor} text-white shadow-lg`}
                    >
                      <Icon className="w-7 h-7" />
                    </div>
                    <h3 className="text-2xl font-extrabold mb-1 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-500 dark:text-white">
                      {tItem.tier}
                    </h3>
                    <p className="text-sm font-bold text-slate-500 dark:text-slate-400 mb-8">
                      {t("landing.tiers.pointsMultiplier", {
                        mult: tItem.multiplier,
                      })}
                    </p>

                    <div className="pb-6 mb-6 border-b border-slate-100 dark:border-white/5">
                      <p className="text-xs text-slate-400 dark:text-slate-500 font-bold uppercase tracking-widest mb-1.5">
                        {t("landing.tiers.bookInAdvance")}
                      </p>
                      <p className="font-black text-blue-950 dark:text-white text-xl">
                        {t("landing.tiers.upToDays", {
                          days: tItem.bookingWindow.split(" ")[0],
                        })}
                      </p>
                    </div>
                    <ul className="space-y-4">
                      {tItem.benefits.map((benefit, idx) => (
                        ...
                        >
                          <CheckCircle
                            className={`w-5 h-5 shrink-0 ${idx < 2 ? "text-emerald-500" : "text-slate-300 dark:text-slate-700"}`}
                          />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            ...
            <div className="flex flex-col gap-2 shrink-0">
              <label
                htmlFor="feedback-branch-select"
                className="text-xs font-bold text-slate-400 dark:text-slate-550 uppercase tracking-wider"
              >
            ...
            <div className="bg-white dark:bg-[#13151A] rounded-[2rem] p-8 border border-slate-200 dark:border-white/5 shadow-sm space-y-6">
              <div className="text-center py-6 space-y-3">
                ...
                <span className="text-sm font-bold text-slate-500 dark:text-slate-400 block mt-2">
                  {t("landing.feedback.totalFeedbacks", {
                    count: feedbackData?.totalFeedbacks || 0,
                  })}
                </span>
              </div>
              ...
              <div className="pt-6 border-t border-slate-100 dark:border-white/5 space-y-4">
                {(() => {
                  ...
                  const avgStaff =
                    count > 0
                      ? fbs.reduce((acc, f) => acc + f.staffRating, 0) / count
                      : 0;
                  const avgService =
                    count > 0
                      ? fbs.reduce((acc, f) => acc + f.serviceRating, 0) / count
                      : 0;
                  const avgPrice =
                    count > 0
                      ? fbs.reduce((acc, f) => acc + f.priceRating, 0) / count
                      : 0;
                    ...
                    <>
                      ...
                      <div className="space-y-1.5">
                        <div className="flex justify-between text-xs font-bold text-slate-650 dark:text-slate-400">
                          ...
                          <span>
                            {avgStaff > 0 ? avgStaff.toFixed(1) : "5.0"}/5.0
                          </span>
                        </div>
                      ...
                      <div className="space-y-1.5">
                        <div className="flex justify-between text-xs font-bold text-slate-650 dark:text-slate-400">
                          ...
                          <span>
                            {avgService > 0 ? avgService.toFixed(1) : "5.0"}/5.0
                          </span>
                        </div>
                        <div className="w-full h-2 bg-slate-100 dark:bg-white/5 rounded-full overflow-hidden">
                          <div
                      ...
                      <div className="space-y-1.5">
                        <div className="flex justify-between text-xs font-bold text-slate-650 dark:text-slate-400">
                          ...
                          <span>
                            {avgPrice > 0 ? avgPrice.toFixed(1) : "5.0"}/5.0
                          </span>
                        </div>
                        <div className="w-full h-2 bg-slate-100 dark:bg-white/5 rounded-full overflow-hidden">
                          <div
              ...
              {isLoadingFeedback ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {[...Array(4)].map((_, i) => (
                    <div
                      key={i}
                      className="bg-white dark:bg-[#13151A] rounded-[2rem] p-6 border border-slate-200 dark:border-white/5 animate-pulse space-y-4"
                    >
                      <div className="flex items-center gap-4">
                ...
                <>
                      ...
                      return (
                        ...
                        >
                          <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between gap-3">
                              <div className="flex items-center gap-3">
                                <div
                                  className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm ${colorClass} shrink-0`}
                                >
                                  {initials}
                                </div>
                          ...
                          <div className="mt-4 pt-4 border-t border-slate-100 dark:border-white/5 flex items-center gap-4 text-[10px] font-bold text-slate-450 dark:text-slate-500">
                            <div>
                              {t("landing.feedback.staff")}:{" "}
                              <span className="text-amber-500">
                                {fb.staffRating}★
                              </span>
                            </div>
                            <div>
                              {t("landing.feedback.service")}:{" "}
                              <span className="text-blue-500">
                                {fb.serviceRating}★
                              </span>
                            </div>
                            <div>
                              {t("landing.feedback.price")}:{" "}
                  ...
                  {totalPages > 1 && (
                    <div className="flex items-center justify-between pt-4">
                      <button
                        onClick={() =>
                          setFeedbackPageIndex((p) => Math.max(p - 1, 1))
                        }
                      ...
                      <span className="text-xs font-bold text-slate-500 dark:text-slate-400">
                        {t("landing.feedback.page", {
                          current: feedbackPageIndex,
                          total: totalPages,
                        })}
                      </span>
      ...
      <section className="relative py-32 px-6 lg:px-12 bg-white dark:bg-[#0B0C10] z-10 border-t border-slate-200 dark:border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-20 space-y-4">
            <h2 className="text-4xl lg:text-5xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-500 dark:text-white">
              {t("landing.branchSystem")}
            </h2>
            <p className="text-lg text-slate-500 dark:text-slate-400 font-medium">
              {t("landing.branchSystemDesc")}
            </p>
          </div>
                ...
                branches.map((branch) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <h3 className="font-extrabold text-blue-950 dark:text-white text-lg">
                        {branch.branchName}
                      </h3>
      ...
      <footer className="bg-slate-50 dark:bg-[#08090C] py-12 px-6 border-t border-slate-200 dark:border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            <span className="font-extrabold text-blue-950 dark:text-white text-xl tracking-tight">
              AutoWash Premium
            </span>
          </div>
